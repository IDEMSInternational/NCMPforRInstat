#' @title Calculating Trends Graphs
#'
#' @description
#' This function reads the indices calculated previously and calculates the trend for 
#' the period specified by the user.It produces a map of each of these trends by station.
#'
#' @param a2 data.frame containing 21 indices from p2_indices()
#' @param station name of station column in a2
#' @param a2_year name of year column in a2
#' @param month name of month column in a2
#' @param a4 data.frame containing main output data.frame() from p4_region_average()
#' @param a4_year name of year column in a4
#' @param a4_month name of month column in a4
#' @param ne (optional) which indices to compute region average for, 1 to 8.
#' @param nyba (optional) start year for region average (if missing will use beginning year from a4)
#' @param nyea (optional) end year for region average (if missing will use end year from a4)
#' @param nyb (optional) start year for station trend (if missing will use nyba)
...
#'
#' @return
#' A list containing data frames with trends and significance values for both stations and regions.
#' 
#' @export
#' 
#' 
...
#' This function reads the indices calculated previously and calculates the trend for the period specified by the user.
#' It produces a map of each of these trends by station.
#' 
#' 
#' @examples
